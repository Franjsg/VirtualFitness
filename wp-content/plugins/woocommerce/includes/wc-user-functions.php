...
if ( ! function_exists( 'wc_create_new_customer' ) ) {
	 ...
	 */
	function wc_create_new_customer( $email, $username = '', $password = '', $confirmpass = '', $per=false, $args = array() ) {
		...
		if ( !$per && 'yes' === get_option( 'woocommerce_registration_generate_password' ) && empty( $password ) ) {
			$password           = wp_generate_password();
			$password_generated = true;
		}

		if ( !$per && empty( $password ) || ( (empty($confirmpass) || $confirmpass != $password) && $per) ) {
