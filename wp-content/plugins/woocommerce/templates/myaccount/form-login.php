...
?>
	...
	<p class="form-row form-row-first">
        <label for="contraseña"><?php _e( 'Contraseña', 'woocommerce' ); ?><span class="required">*</span></label>
        <input type="password" class="input-text" name="password" id="password" value="<?php if ( ! empty( $_POST['password'] ) ) esc_attr_e( $_POST['password'] ); ?>" />
    </p>
	<p class="form-row form-row-last">
        <label for="password"><?php _e( 'Confirma contraseña', 'woocommerce' ); ?><span class="required">*</span></label>
        <input type="password" class="input-text" name="confirmpassword" id="confirmpassword" value="<?php if ( ! empty( $_POST['confirmpassword'] ) ) esc_attr_e( $_POST['password'] ); ?>" />
    </p>
    <div class="clear"></div>
<?php
}
