...
<article>
	<h1><?php the_title(); ?></h1>
	<?php if(get_theme_mod('the_wp_fitness_single_post_date',true)==1 || get_theme_mod('the_wp_fitness_single_post_author',true)==1 || get_theme_mod('the_wp_fitness_single_post_comment_no',true)==1){ ?>
