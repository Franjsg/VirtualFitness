    ...
    function envo_shopper_head_compare() {
        if (function_exists('yith_woocompare_constructor')) {
            ...
            <div class="header-compare product">
                <a id="header-compare product-custom" style="display:none" lass="compare added" rel="nofollow" href="<?php echo esc_url($yith_woocompare->obj->view_table_url()); ?>" data-tooltip="<?php esc_attr_e('Compare', 'envo-shopper'); ?>" title="<?php esc_attr_e('Compare', 'envo-shopper'); ?>">
